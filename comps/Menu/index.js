...
const Menu = ({expand, onMenuSelect}) =>{
 ...
 //step 6, use interactions to make components to pass information to the pages. e.g. onclick is the interactions, and it will excute 'onMenuSelect' function and will go through the pages and tell them with 'str'. if str === bg or img or help, it will take an motion based on it.